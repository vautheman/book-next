...
export default function Header() {
  return (
    <header className="grid xl:grid-cols-2 container px-10 h-screen">
      <div className='flex flex-col justify-center gap-8 h-full'>
        <h1 className="font-title font-bold text-7xl md:text-8xl"><span className="text-secondary">Graphic</span> Design and <span className="text-primary">Front-End</span> Developer</h1>
